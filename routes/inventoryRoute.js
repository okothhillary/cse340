...
router.get("/delete/:inventory_id", utilities.handleErrors(invController.deleteItemView))
router.post("/delete/:inventory_id", utilities.handleErrors(invController.deleteItemHandler))
